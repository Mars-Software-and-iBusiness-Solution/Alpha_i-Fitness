...
public class Track_Progress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_track__progress);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item)
            {
                ...
                {
                    Intent editpro = new Intent(Track_Progress.this, Edit_Profile.class);
                ...
                else if(id == R.id.trackmyprogress)
                {
                    ...
                    Intent trackpro = new Intent(Track_Progress.this, Track_Progress.class );
                ...
                else if(id == R.id.basic_workouts)
                {
                    ...
                    Intent basicwork = new Intent(Track_Progress.this, Check_Health.class);
                ...
                else if(id == R.id.findmeaworkout)
                {
                    ...
                    Intent findtrain = new Intent(Track_Progress.this, Basic_Workouts.class);
                ...
                else if(id == R.id.consultacoach)
                {
                    ...
                    Intent mytrain = new Intent(Track_Progress.this, My_Trainer.class);
                    startActivity(mytrain);
                    finish();
                }else if(id == R.id.search_user)
                {

                    Intent shareex = new Intent(Track_Progress.this, Share_Experience.class);
                ...
                else if(id == R.id.settings)
                {
                    ...
                    Intent settings = new Intent(Track_Progress.this, Settings.class);
                ...
                else if(id == R.id.logout)
                {
                    ...
                    Toast.makeText(Track_Progress.this, "You Have been Sign-out successfully!", Toast.LENGTH_SHORT).show();
                    finish();
                    FirebaseAuth.getInstance().signOut();
                    Intent loginIntent = new Intent(Track_Progress.this, MainActivity.class );
    ...
    public void onBackPressed() {
        ...
        Intent registerIntent = new Intent(Track_Progress.this, Home_iFit.class);
