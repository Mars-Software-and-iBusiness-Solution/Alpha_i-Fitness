...
public class Check_Health extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_check__health);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item)
            {
                ...
                {
                    Intent editpro = new Intent(Check_Health.this, Edit_Profile.class);
                ...
                else if(id == R.id.trackmyprogress)
                {
                    ...
                    Intent trackpro = new Intent(Check_Health.this, Track_Progress.class );
                ...
                else if(id == R.id.basic_workouts)
                {
                    ...
                    Intent basicwork = new Intent(Check_Health.this, Check_Health.class);
                ...
                else if(id == R.id.findmeaworkout)
                {
                    ...
                    Intent findtrain = new Intent(Check_Health.this, Basic_Workouts.class);
                ...
                else if(id == R.id.consultacoach)
                {
                    ...
                    Intent mytrain = new Intent(Check_Health.this, My_Trainer.class);
                    startActivity(mytrain);
                    finish();
                }else if(id == R.id.search_user)
                {

                    Intent shareex = new Intent(Check_Health.this, Share_Experience.class);
                ...
                else if(id == R.id.settings)
                {
                    ...
                    Intent settings = new Intent(Check_Health.this, Settings.class);
                ...
                else if(id == R.id.logout)
                {
                    ...
                    Toast.makeText(Check_Health.this, "You Have been Sign-out successfully!", Toast.LENGTH_SHORT).show();
                    finish();
                    FirebaseAuth.getInstance().signOut();
                    Intent loginIntent = new Intent(Check_Health.this, MainActivity.class );
    ...
    public void onBackPressed() {
        ...
        Intent registerIntent = new Intent(Check_Health.this, Home_iFit.class);
