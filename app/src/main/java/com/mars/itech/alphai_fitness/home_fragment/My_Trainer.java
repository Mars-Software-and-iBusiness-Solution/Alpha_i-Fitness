...
public class My_Trainer extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my__trainer);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item)
            {
                ...
                {
                    Intent editpro = new Intent(My_Trainer.this, Edit_Profile.class);
                ...
                else if(id == R.id.trackmyprogress)
                {
                    ...
                    Intent trackpro = new Intent(My_Trainer.this, Track_Progress.class );
                ...
                else if(id == R.id.basic_workouts)
                {
                    ...
                    Intent basicwork = new Intent(My_Trainer.this, Check_Health.class);
                ...
                else if(id == R.id.findmeaworkout)
                {
                    ...
                    Intent findtrain = new Intent(My_Trainer.this, Basic_Workouts.class);
                ...
                else if(id == R.id.consultacoach)
                {
                    ...
                    Intent mytrain = new Intent(My_Trainer.this, My_Trainer.class);
                    startActivity(mytrain);
                    finish();
                }else if(id == R.id.search_user)
                {

                    Intent shareex = new Intent(My_Trainer.this, Share_Experience.class);
                ...
                else if(id == R.id.settings)
                {
                    ...
                    Intent settings = new Intent(My_Trainer.this, Settings.class);
                ...
                else if(id == R.id.logout)
                {
                    ...
                    Toast.makeText(My_Trainer.this, "You Have been Sign-out successfully!", Toast.LENGTH_SHORT).show();
                    finish();
                    FirebaseAuth.getInstance().signOut();
                    Intent loginIntent = new Intent(My_Trainer.this, MainActivity.class );
    ...
    public void onBackPressed() {
        ...
        Intent registerIntent = new Intent(My_Trainer.this, Home_iFit.class);
